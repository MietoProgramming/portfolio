...
const About = () => {
  ...
  return (
    <div className="aboutContainer" onClick={() => handleUnclick()}>
      ...
      >
        <img src="./portfolio/passions.png" alt="passion" />
      </div>
      <div
        className={showIcons ? "icon" : "icon inactive"}
        onClick={() => {
      ...
      >
        <img src="./portfolio/education.png" alt="education" />
      </div>
      <div
        className={showIcons ? "icon" : "icon inactive"}
        onClick={() => {
      ...
      >
        <img src="./portfolio/work.png" alt="work" />
      </div>
      ...
      <div className={dialogTwoShow ? "preview active" : "preview"}>
        <div className="iconBubble">
          <img src="./portfolio/education.png" alt="edication" />
        </div>
        <div className="descBubble">
